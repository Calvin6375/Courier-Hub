...
public class CancelOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/courierhub/cancel-order-flat-icon-vector copy.jpg"))); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jSname)
                                        .addComponent(jPid)
                                        .addComponent(jReason, javax.swing.GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE))))
    ...
    // Insertion operation
    PreparedStatement psInsert = con.prepareStatement("INSERT INTO canceled (Package_ID, SenderName, Reason) VALUES (?, ?, ?)");
    psInsert.setString(1, Package_ID);
    psInsert.setString(2, Sname);
    psInsert.setString(3, Reason);
    psInsert.executeUpdate();
    
    // Deletion operation
    PreparedStatement psDelete = con.prepareStatement("DELETE FROM neworder WHERE Package_ID = ?");
    psDelete.setString(1, Package_ID);
    psDelete.executeUpdate();
    
    JOptionPane.showMessageDialog(this, "Order canceled successfully");

} catch (Exception ex) {
    JOptionPane.showMessageDialog(this, "Order not canceled successfully");
    ex.printStackTrace(); // This will print the exception details to the console for debugging purposes
}
